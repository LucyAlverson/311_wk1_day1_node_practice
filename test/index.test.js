...
describe('Strings module', () => {
  ...
  test.npm('Split a string on the given delimeter', () => {
  ...
  test.npm('Break a string into pairs', () => {
...
describe('Dates module', () => {
  ...
  test.npm('Return today\'s day - ex. Monday', () => {
    const weekdays = [
      'Monday',
      'Tuesday',
      'Wednesday',
  ...
  test.npm('Return today\'s date in the format: May 29, 2019', () => {
    const cal = dates.calendar()
    expect(cal).toMatch(/^[A-z]{3} [0-9]{2}, [0-9]{4}$/)
  })

  test.npm('Return the current time in the format: 03:21:51 PM', () => {
